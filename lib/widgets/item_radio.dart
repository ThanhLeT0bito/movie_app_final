...
class ItemRadioWiget extends StatefulWidget {
  ...
  @override
  State<ItemRadioWiget> createState() => _ItemRadioWigetState();
}

class _ItemRadioWigetState extends State<ItemRadioWiget> {
  @override
  void initState() {
    super.initState();
  }
