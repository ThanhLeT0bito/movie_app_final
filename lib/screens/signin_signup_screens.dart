...
class SignInSignUpScreens extends StatefulWidget {
  const SignInSignUpScreens({Key? key}) : super(key: key);
  static const routeName = 'SignIn_SignUp';

  @override
  State<SignInSignUpScreens> createState() => _SignInSignUpScreensState();
}

class _SignInSignUpScreensState extends State<SignInSignUpScreens> {
  int indexSelect = 0;
