              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20,),
                      PaymentMethod(
                        img:'assets/shoppe.png',
                        title: 'Shoppe Pay'),
                    SizedBox(height: 20,),
                     PaymentMethod(
                      img:'assets/atm card.png',
                      title: 'ATM Card'),
                    SizedBox(height: 20,),
                     PaymentMethod(
                      img:'assets/atm.png',
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: 16.0,color: AppColors.BaseColorWhite),
                        ),
                        Text(
                          '15:00', 
                          style: TextStyle(fontSize: 16.0,color: AppColors.BaseColorTextMain,fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                    )         
